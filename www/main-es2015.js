...
let config = new angular4_social_login__WEBPACK_IMPORTED_MODULE_15__["AuthServiceConfig"]([
    {
...
let HttpAngularProvider = class HttpAngularProvider {
    constructor(http) {
        this.http = http;
    }
...
HttpAngularProvider.ctorParameters = () => [
...
let HttpNativeProvider = class HttpNativeProvider {
    constructor(http) {
        this.http = http;
    }
    get(url, params, options = {}) {
...
HttpNativeProvider.ctorParameters = () => [
...
let HttpProvider = class HttpProvider {
    constructor(platform, angularHttp, nativeHttp) {
        this.platform = platform;
